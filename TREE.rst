...
.. [1] The version of scheduler and version of templates is not the same as
   version of application. It's expected that scheduler and templates change
   very rarely and only by admins, not by release managers. Also you might use
   "shadow" scheduler and "shadow" template renderer for debugging.
